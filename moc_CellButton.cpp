...
QT_MOC_LITERAL(1, 11, 11), // "leftClicked"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 1), // "x"
QT_MOC_LITERAL(4, 26, 1), // "y"
QT_MOC_LITERAL(5, 28, 12) // "rightClicked"

    },
    "CellButton\0leftClicked\0\0x\0y\0rightClicked"
};
...
void CellButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CellButton *_t = static_cast<CellButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->leftClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            typedef void (CellButton::*_t)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CellButton::leftClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CellButton::*_t)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CellButton::rightClicked)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CellButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_CellButton.data,
      qt_meta_data_CellButton,  qt_static_metacall, nullptr, nullptr}
};
